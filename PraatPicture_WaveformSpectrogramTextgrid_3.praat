...
beginPause: "User input"
	...
	comment: "These are the default values for the coordinates of the TextGrid with one tier. If it's two tiers, specify 3.5 for text_y_bottom; if three tiers, 3.75."
